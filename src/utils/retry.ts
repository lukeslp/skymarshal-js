 ...
 */
function calculateBackoffDelay(attempt: number, config: Required<Omit<RetryConfig, 'shouldRetry' | 'onRetry'>>): number {
...
function shouldRetryError(
  error: unknown,
  attempt: number,
  config: Required<Omit<RetryConfig, 'shouldRetry' | 'onRetry'>> & Pick<RetryConfig, 'shouldRetry'>
): boolean {
 ...
 */
export function createRetryable<Args extends any[], Return>(
